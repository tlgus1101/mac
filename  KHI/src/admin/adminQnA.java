...
public class adminQnA extends ActionSupport {
	...
	public adminQnA() throws IOException {
	...
	public String execute() throws Exception {
		...
		optionNum = 1;
		list = sqlMapper.queryForList("yh.selectQMOM");
