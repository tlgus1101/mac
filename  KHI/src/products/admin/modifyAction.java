...
//		System.out.println("Ÿ��: "+ getP_type());

		sqlMapper.update("products.p_updateProducts", paramClass);
		
		// �̹��� ������ ����Ǿ��ٸ�?
		if (getUpload() != null) {
			
//			System.out.println("�۹�ȣ ��������: "+ getP_no());
			
			String file_name="fime_"+getP_no()+"_"+filename_date;// ���� �̸� ����
		...
		if(getP_quan() <= 0) {
			...
			paramClass.setP_option(2);
			
			sqlMapper.update("products.p_quanAdminZero", paramClass);
		}
