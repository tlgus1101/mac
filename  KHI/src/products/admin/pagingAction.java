...
//		System.out.println("페이지 "+totalPage);
		...
		if(currentPage>blockPage) {
			pagingHtml.append("<a href=p_listAction.aciton?currentPage="+(startPage+1)+">");
...
//			}
			if(i==currentPage) {
				...
				pagingHtml.append("&nbsp;<a href='p_adminList.action?currentPage=");
				pagingHtml.append(i);
				pagingHtml.append("'>");
				pagingHtml.append(i);
				pagingHtml.append("</a>");
...
//			System.out.println("i"+pagingHtml);
		...
		if(totalPage-startPage >= blockPage) {
			pagingHtml.append("<a href=p_listAction.action?currentPage="+(endPage+1)+">");
