...
public class CalendarAction extends ActionSupport {
	...
	public String execute() throws SQLException, ParseException {
		...
		calendHtml.append("<td  align = 'center' bgcolor='#013e97' style='background:url(./image/bgcolor.png)' ><a style='color:black' href='/_KHI/CalendarAction.action?year=" + year + 
		...
		calendHtml.append("<td style='background:url(./image/bgcolor.png)' bgcolor='#013e97' align = 'center'><a style='color:black'  href='/_KHI/CalendarAction.action?year=" + year + "&month=" + (month + 1) + "&date=" + date + "'><img src='./image/right.png'width='15' height='15'> </a></td>");
			...
			for (int j = 1; j <= 7; j++) {
				...
				if (curCol < firstDay + 1) {
					...
					if (dayNum == 0) {
						...
						{
							url="'/_KHI/yh/CUSwriteForm.action?year=";
						}
						switch (j) {
						case 1:
