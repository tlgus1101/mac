...
<body>
	...
	</script> <article class="bbs-list-con">
			...
			<s:iterator value="list" status="stat">
				...
				<div class="bbs-list-row">
					...
					<div class="column bbs-title">
						<a
							href='CminiviewAction.action?q_num=<s:property value="q_num"/>&currentPage=<s:property value="currentPage"/>'>
					...
					<div class="column bbs-inline" data-label="답변상태">
						<s:if test="checkre == 1">
							<input name="list" type="button" value="답변하기" class="inputb"
								onclick="javascript:location.href='CreplyForm.action?q_num=<s:property value="q_num"/>&currentPage=<s:property value="currentPage"/>'">
						</s:if>
						<s:else>답변 완료</s:else>
						</td>
					</div>
	...
	<tr align="center">
		<td colspan="5">
			<div class="cm-btn-controls">
				<a
					href="javascript:open_win_search('CUSlistAction.action?currentPage=<s:property value="currentPage"/>','CUSlist')"
