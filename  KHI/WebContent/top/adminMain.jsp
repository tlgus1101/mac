...
<link rel="stylesheet" href="top/AMain.css">
...
<body>
 ...
 <script type="text/javascript">
      ...
      function ProductsOpen() {
         location.href = "products/p_adminList.action?tap=1";
      }
      function NoticeListOpen() {
         location.href = "notice/noticeAListAction.action?tap=2";
      }
      function WindowListOpen() {
         location.href = "adminList.action?tap=3";
      }
      function reservMinOpen() {
         location.href = "AdminMainAction.action?tap=4";
      }
      function CMMinOpen() {
         location.href = "yh/CminiAction.action?tap=5";
      }

      function QnAMinOpen() {
         location.href = "yh/QminiAction.action?tap=6";
      }
   </script>
<!--[if lt IE 7]>
