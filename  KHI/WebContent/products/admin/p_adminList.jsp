...
<center>
		<div id="middleArea">
			...
			<h3 class="content-tit" align="center">　　재고관리　　</h3>
			<div class="location">
				<ul>
					<li><img
			...
			<div class="bbs-list-tbl">
				<p class="bbs-list-head">
					...
					<span style="width: 10%;">등록일</span> <span style="width: 17%;"><a
						href="p_adminList.action?sortByQuan=2">▲</a> 재고수량 <a
						href="p_adminList.action?sortByQuan=1">▼</a></span> <span
						style="width: 20%;"><a
						href="p_adminList.action?sortByOption=2">▲</a> 판매정보 <a
						href="p_adminList.action?sortByOption=1">▼</a></span>
				</p>
				<!-- 공지사항 -->
						...
						<s:url id="viewURL" action="p_adminView">
							...
							<div class="bbs-list-row">
								...
								<div class="column bbs-title">
									...
									<a
										href='p_adminView.action?tap=1&p_no=<s:property value="p_no" />&currentPage=<s:property value="currentPage" />'>
								...
								<div class="column bbs-inline" data-label="판매정보">
									<s:if test="p_option==1">판매중
			</s:if>
									<s:elseif test="p_option==2">재고없음
			</s:elseif>
								</div>
							</div>
			...
			<div class="cm-btn-controls">
				<a href="javascript:location.href='p_writeForm.action?currentPage=<s:property value="currentPage" />';" />글쓰기</a>
				<a href="javascript:admin_finishSale()">판매종료</a>
			</div>
			...
			<form name="bbs_search_form" method="post">
			
				<div class="board-search-box">
					<select name="searchNum">
						<option value="0">이름</option>
						<option value="1">번호</option>
					</select> <input placeholder="검색어를 입력해주세요" type="search" name="searchKeyword"
