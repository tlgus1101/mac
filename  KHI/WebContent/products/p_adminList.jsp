...
<table width="600" border="1" cellspacing="0" cellpadding="2">
	...
	<input type="button" value="홈 " onclick="admin_mainOpen()">
	<input type="button" value="판매종료 " onclick="admin_finishSale()"></td></tr>
	<tr align="center">
        ...
        <td width="200">
        	<strong>
        		<a href="p_adminList.action?sortByQuan=2">▲</a>
        		재고수량
        		<a href="p_adminList.action?sortByQuan=1">▼</a>
        	</strong>
        </td>
		<td width="200">
			<strong>
	        	<a href="p_adminList.action?sortByOption=2">▲</a>			
				판매정보
        		<a href="p_adminList.action?sortByOption=1">▼</a>
			</strong>
		</td>
	</tr>
	...
	<s:iterator value="list" status="stat">
		...
		<tr align="center">
        	...
        	<td align="left"> &nbsp;<s:a href="%{viewURL}"><s:property value="p_name" /></s:a></td>
...
검색 &nbsp;&nbsp;&nbsp;
	...
	<s:textfield name="searchKeyword" theme="simple" value="" cssStyle="width:160px" maxlength="100"/>
