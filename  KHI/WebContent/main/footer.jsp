...
<script type="text/javascript">
		function privacyOpen() {
			var oWin = window
					.open("http://localhost:8080/_KHI/main/privacy.jsp", name,
							"scrollbars=no,status=no,resizable=no,width=500,height=500");
		}
		function EmailOpen() {
			var oWin = window
					.open("http://localhost:8080/_KHI/main/Email.jsp", name,
							"scrollbars=no,status=no,resizable=no,width=500,height=500");
		}
		function TermsOfServiceOpen() {
			var oWin = window
					.open("http://localhost:8080/_KHI/main/Termsofservice.jsp", name,
							"scrollbars=no,status=no,resizable=no,width=500,height=500");
		}
		</script>
</head>
...
<footer id="footer">
	...
	<div id="footerInner">
			...
			<div class="foot-info clearfix area" >
				<ul class="clearfix">
					<li><a href="javascript:;" onclick="privacyOpen()"><b>개인정보처리방침</b></a></li>
					<li><a href="javascript:;" onclick="EmailOpen()">이메일무단수집거부</a></li>
					<li><a href="javascript:;" onclick="TermsOfServiceOpen()">이용약관</a></li>
				</ul>
				<div class="foot-address">
					<p><span class="no-line">회사명 : 시현창호 </span>     <span>대표 : 이시현</span>      <span>주소 : 경기도 시흥시 금화로 627번길 12-10 (금이동 289-3)</span><br>
					<span class="no-line">TEL : 031-404-4045</span> <span>FAX : 031-404-4046 </span> <span>Email : mdragon28@naver.com</span> </p>
					<p class="copy">COPYRIGHT © 2018 <b>HGWINDOW</b> ALL RIGHT RESERVED</p>
				</div>
				<div class="to-top-btn-box"><a href="javascript:;" title="상단으로" class="to-top-btn"><img src="http://hgwindow.co.kr/images/button/to_top_btn.jpg" alt=""></a></div>
			</div>
		</div>
