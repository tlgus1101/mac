...
<link rel="stylesheet" href="/KHI/top/AMain.css">
...
<body>
 ...
 <script type="text/javascript">
      ...
      function ProductsOpen() {
         location.href = "/KHI/products/p_adminList.action?tap=1";
      }
      function NoticeListOpen() {
         location.href = "/KHI/notice/noticeAListAction.action?tap=2";
      }
      function WindowListOpen() {
         location.href = "/KHI/adminList.action?tap=3";
      }
      function reservMinOpen() {
         location.href = "/KHI/AdminMainAction.action?tap=4";
      }
      function CMMinOpen() {
         location.href = "/KHI/yh/CminiAction.action?tap=5";
      }

      function QnAMinOpen() {
         location.href = "/KHI/yh/QminiAction.action?tap=6";
      }
   </script>
<!--[if lt IE 7]>
