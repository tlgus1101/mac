...
<article class="bbs-view-con">
	<aside class="bbs-view-top">
		...
		<pre><div class="bbs-view-content editor" >&nbsp;&nbsp;<img src="./images/<s:property value="resultClass.v_imagesv"/>"width="400" height="500">&nbsp;&nbsp;<h1><s:property value="resultClass.v_content"/></h1></div>
		</pre>
