	...
	<div class="bbs-view-content editor" >
		...
		<div class="cm-btn-controls">
			<div class="right-btn-controls">
				<a href="javascript:location.href='QreplyForm.action?q_num=<s:property value="q_num" />&currentPage=<s:property value="currentPage" />'">답변</a>
				<a href="javascript:open_win_noresizable('checkadminForm.action?q_num=<s:property value="resultClass.q_num"/>&currentPage=<s:property value="currentPage"/>','QnAmodify')">수정</a>
				<a href="javascript:open_win_noresizable('checkadminForm.action?q_num=<s:property value="resultClass.q_num"/>&currentPage=<s:property value="currentPage"/>','QnAdelete')">삭제</a>
				<a href="QminiAction.action?currentPage=<s:property value="currentPage" />">목록</a>
			</div>
		</div>
</body>
</html>
