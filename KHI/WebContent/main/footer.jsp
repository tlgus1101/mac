...
<script type="text/javascript">
		function privacyOpen() {
			var oWin = window
					.open("http://localhost:8080/KHI/main/privacy.jsp", name,
							"scrollbars=no,status=no,resizable=no,width=500,height=500");
		}
		function EmailOpen() {
			var oWin = window
					.open("http://localhost:8080/KHI/main/Email.jsp", name,
							"scrollbars=no,status=no,resizable=no,width=500,height=500");
		}
		function TermsOfServiceOpen() {
			var oWin = window
					.open("http://localhost:8080/KHI/main/Termsofservice.jsp", name,
							"scrollbars=no,status=no,resizable=no,width=500,height=500");
		}
		</script>
</head>
