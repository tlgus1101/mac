...
<meta property="og:url" content="http://hgwindow.co.kr/kr/notice/notice.php">
...
<meta name="twitter:domain" content="http://hgwindow.co.kr/kr/notice/notice.php">
...
<div id="wrap" class="sub-page">
	...
	<div id="container">
		...
		<section id="visual" style="background:#fff url(http://hgwindow.co.kr/images/layout/sub_visual_06.jpg) no-repeat 50% 0%">
			...
			<!--  <a href="/kr/company/ceo.php" class="sub-page-controls-btn sub-next-page-btn"><span>회사소개</span></a>-->
			</div>
		</section>
		<!-- //visual -->
		<!-- sideMenu -->
		<aside id="sideMenu">
			<ul class="snb clearfix">
										<li class="on"><a href="noticeListAction.action">공지사항</a></li>
					</ul>
		</aside>
		<!-- //sideMenu -->
		<!-- middleArea -->
