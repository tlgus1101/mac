...
<head>
<title>문의사항</title>
<link rel="stylesheet" href="/KHI/QnA/common/css/css.css" type="text/css">
...
<table width="600", border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="right" colspan="2">
			...
			onclick="javascript:open_win_noresizable('checkForm.action?q_num=<s:property value="resultClass.q_num"/>&currentPage=<s:property value="currentPage"/>','QnAmodify')">
			<input name="list" type="button" value="삭제" class="inputb" 
			onclick="javascript:open_win_noresizable('checkForm.action?q_num=<s:property value="resultClass.q_num"/>&currentPage=<s:property value="currentPage"/>','QnAdelete')">
