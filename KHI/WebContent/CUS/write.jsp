...
<body>
	...
	<table width="600" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td bgcolor="#FFFFFF"><s:textfield name="q_date" theme="simple"
					value="%{resultClass.q_date}" cssStyle="width:279px" maxlength="30" />
				<font color="#FF0000"> ex) yyyy-mm-dd</font></td>
		</tr>
		...
		<tr>
			<td align="right" colspan="2"><input name="submit" type="submit"
				value="작성완료" class="inputb"> <input name="list"
					...
					onclick="javascript:location.href='CUSlistAction.action?currentPage=<s:property value="currentPage"/>'"></td>
		</tr>
	</table>
